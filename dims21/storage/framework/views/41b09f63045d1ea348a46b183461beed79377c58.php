...
<script>
    ...
    var jArray = JSON.stringify(<?php echo json_encode($cutoff); ?>);
    ...
    $.ajaxSetup({
        ...
        editing: {
                                ...
                                onRowUpdated: function(e) {
                                    $.ajax({
                                        url:'<?php echo url("/updateCutoffTime"); ?>',
                                        type: "POST",
                                        data:{
                                            ID: e.key.ID,
...
<?php /**PATH C:\Users\deadl\Downloads\smdfmerchieadmin (3)\smdfmerchieadmin\dims21\resources\views/merchie/cutofftime.blade.php ENDPATH**/ ?>