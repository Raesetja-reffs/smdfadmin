...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(url('images/linx.jpg')); ?>">
    ...
    <link href="<?php echo e(asset('css/smoothcss.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/jquery.dataTables.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/scroller.dataTables.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/fonts.css')); ?>" rel="stylesheet"  type='text/css'>
    <link href="<?php echo e(asset('css/tippop.css')); ?>" rel="stylesheet"  type='text/css'>
    <link href="<?php echo e(asset('css/jquery.inputpicker.css')); ?>" rel="stylesheet"  type='text/css'>
    <link href="<?php echo e(asset('css/easy-autocomplete.min.css')); ?>" rel="stylesheet"  type='text/css'>
    <link href="<?php echo e(asset('css/jquery.multiselect.css')); ?>" rel="stylesheet"  type='text/css'>
    <link href="<?php echo e(asset('css/datatablesblocked.css')); ?>" rel="stylesheet"  type='text/css'>

    <link href="<?php echo e(asset('css/jquery.flexdatalist.min.css')); ?>" rel="stylesheet"  type='text/css'>
    <link href="<?php echo e(asset('css/excel-bootstrap-table-filter-style.css')); ?>" rel="stylesheet"  type='text/css'>
    <link href="<?php echo e(asset('css/contextMenu.css')); ?>" rel="stylesheet"  type='text/css'>
    ...
    <script src="<?php echo e(asset('public/js/colResizable-1.6.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery-ui.js')); ?>"></script>


    <script src="<?php echo e(asset('js/jquery.mcautocomplete.js')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery.dialogextend.js')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery.dataTables.min.js')); ?>"></script>

    <script src="<?php echo e(asset('js/dataTables.select.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/commonScript.js')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery.pleaseWait.js')); ?>"></script>
    <script src="<?php echo e(asset('js/jspdf.debug.js')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery.tippop.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('js/contextMenu.js')); ?>"></script>
    <!--<script src="https://use.fontawesome.com/0f659c6d48.js"></script>-->
    <script src="<?php echo e(asset('public/js/jqueryprint.js')); ?>"></script>
...
'left=20,top=20,width=1250,height=1250,toolbar=1,resizable=0'); return false;" >Customer Special</a>
                                ...
                                <?php endif; ?>
                                <li>
                                    <a href='<?php echo url("/import_excel"); ?>' onclick="window.open(this.href, 'pricelistimport',
'left=20,top=20,width=1250,height=1250,toolbar=1,resizable=0'); return false;" >DIMS Price List Import</a>
                                </li>

                                <li>
                                    <a href='<?php echo url("/massgridspecialscustomer"); ?>' onclick="window.open(this.href, 'massGrid',
'left=20,top=20,width=1600,height=800,toolbar=1,resizable=0'); return false;" >Mass Customer Specials</a>
                                </li>

                                <?php if($groupspecialAccess != "0"): ?>
                                <li>
                                    <a href='<?php echo url("/groupspecials"); ?>' onclick="window.open(this.href, 'roupspecials',
'left=20,top=20,width=1250,height=1250,toolbar=1,resizable=0'); return false;" >Group Specials</a>
                                </li>
                                <?php endif; ?>
                                <?php if($overallspecial != "0"): ?>
                                <li>
                                    <a href='<?php echo url("/overallspecials"); ?>' onclick="window.open(this.href, 'overallspecials',
'left=20,top=20,width=1250,height=1250,toolbar=1,resizable=0'); return false;" >Overall Specials</a>
                                </li>
                                <?php endif; ?>
                                <?php if($console !="0"): ?>
                                <li>
                                    <a href='<?php echo url("/managementSearch"); ?>' onclick="window.open(this.href, 'managementSearch',
'left=20,top=20,width=1500,height=1250,toolbar=1,resizable=0'); return false;" >Management Console</a>
                                ...
                                <li>
                                    ...
                                    <a href='<?php echo url("/getreportLayout"); ?>' onclick="window.open(this.href, 'reports',
'left=20,top=20,width=1500,height=1000,toolbar=1,resizable=0'); return false;" >Reports</a>
                                </li>

                                <?php if($backorders !="0"): ?>
                                <li>
                                    <a href='<?php echo url("/remoteordersbackorders"); ?>'  onclick="window.open(this.href, 'remoteordersbackorders',
'left=20,top=20,width=900,height=900,toolbar=1,resizable=0'); return false;">Back Orders</a>
                                </li>
                                <?php endif; ?>

                                <li>
                                    <a href='<?php echo url("/routeplanner"); ?>' target="_blank">Route Plan</a>
                                </li>


                                <li>
                                    <a href='<?php echo url("/customersalespage"); ?>' onclick="window.open(this.href, 'salescustomers',
'left=20,top=20,width=1200,height=950,toolbar=1,resizable=0'); return false;">Customer Sales</a>
                                </li>

                                <li>
                                    <a href='<?php echo url("/getdriverscashoff"); ?>' onclick="window.open(this.href, 'getdriverscashoff',
'left=20,top=20,width=1000,height=950,toolbar=1,resizable=0'); return false;">Drivers Cashoff</a>
                                </li>

                                <li>
                                    <a href='<?php echo url("/viewdailycash"); ?>' onclick="window.open(this.href, 'viewdailycash',
'left=20,top=20,width=1000,height=950,toolbar=1,resizable=0'); return false;">Daily Sales</a>
                                ...
                                <?php if($things != "0"): ?>
                                <li>
                                    <a href='<?php echo url("/getViewCallLogger"); ?>' onclick="window.open(this.href, 'viewdailycash',
'left=20,top=20,width=1000,height=950,toolbar=1,resizable=0'); return false;">Call Logger</a>
                                </li>
                                <?php endif; ?>

                                <li style="display: none;">
                                    <a href='<?php echo url("/gridPickingSlipCollectios"); ?>'  onclick="window.open(this.href, 'gridPickingSlipCollectios',
'left=20,top=20,width=1500,height=500,toolbar=1,resizable=0'); return false;">Picking Slips</a>
                                </li>
                                <?php if(env('APP_STOCK_COUNT_PALLADIUM') =='TRUE'): ?>
                                <li>
                                    <a href='<?php echo url("/getPickingDeptPalladium"); ?>'  onclick="window.open(this.href, 'getPickingDept',
'left=20,top=20,width=1800,height=750,toolbar=1,resizable=0'); return false;">Stock Sheet</a>
                                </li>
                                    <?php else: ?>
                                    <li>
                                        <a href='<?php echo url("/getPickingDept"); ?>'  onclick="window.open(this.href, 'getPickingDept',
'left=20,top=20,width=1800,height=750,toolbar=1,resizable=0'); return false;">Stock Sheet</a>
                                    </li>
                                <?php endif; ?>
                                <?php if($creditreport != "0"): ?>
                                <li>
                                    <a href='<?php echo url("/creditNoteReasonsView"); ?>'  onclick="window.open(this.href, 'creditNoteReasonsView',
'left=20,top=20,width=1800,height=750,toolbar=1,resizable=0'); return false;">Credit Note Report</a>
                                </li>
                                <?php endif; ?>
                                <li>
                                    <a href='<?php echo url("/viewBlockedAccount"); ?>'  onclick="window.open(this.href, 'viewBlockedAccount',
'left=20,top=20,width=1800,height=750,toolbar=1,resizable=0'); return false;">Blocked Orders</a>
                                </li>
                                <li>
                                    <a href='<?php echo url("/getNoStockItem"); ?>'  onclick="window.open(this.href, 'viewBlockedAccount',
'left=20,top=20,width=1800,height=750,toolbar=1,resizable=0'); return false;">No Stock Item</a>
                                </li>
                                <li>
                                    <a href='<?php echo url("/viewStatusReport"); ?>'  onclick="window.open(this.href, 'viewBlockedAccount',
...
'left=20,top=20,width=500,height=400,toolbar=1,resizable=0'); return false;">Download Messaging App</a>
                                ...
                                <?php endif; ?>
                                    <?php if($webstoremassage !=0): ?>
                                    <li>
                                        <a href='<?php echo url("/WebstoreMessages"); ?>' onclick="window.open(this.href, 'WebstoreMessages',
'left=20,top=20,width=1000,height=950,toolbar=1,resizable=0'); return false;">Webstore Messages</a>
                                    </li>
                                    <?php endif; ?>
                                    <li>
                                        <a href='<?php echo url("/PathEditor"); ?>' onclick="window.open(this.href, 'PathEditor',
'left=20,top=20,width=1000,height=950,toolbar=1,resizable=0'); return false;">Edit Printer Paths</a>
                                    </li>
                                    <li>
                                        <a href='<?php echo url("/viewDeletedOrders"); ?>' onclick="window.open(this.href, 'viewDeletedOrders',
'left=20,top=20,width=1000,height=950,toolbar=1,resizable=0'); return false;">Deleted Orders</a>
                     ...
                     document.getElementById('logout-form').submit();">
                                ...
                                <li>
                                    <button class="btn-md btn-primary" id="clearlocks" value="<?php echo e(Auth::user()->UserId); ?>" style="height: 30px;    width: 98%;">Clear Locks</button>
...
$('#clearlocks').click(function(){
    ...
    if($('#orderId').val().length < 3) {
        $.ajax({
            url: '<?php echo url("/deleteuserOrderLocks"); ?>',
            type: "POST",
            data: {
...
<?php /**PATH C:\Users\deadl\Downloads\smdfmerchieadmin (3)\smdfmerchieadmin\dims21\resources\views/layouts/app.blade.php ENDPATH**/ ?>