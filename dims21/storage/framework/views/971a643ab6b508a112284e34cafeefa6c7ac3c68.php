...
<html lang="en">
	<head>
		...
		<link rel="icon" href="<?php echo e(asset('images/logo.png')); ?>" type="image/icon type">
		<!-- CSS only -->
...
<script>
    ...
    function specialsFunction(){
        $.ajax({
            url: '<?php echo url("/getSpecialsHeaders"); ?>',
            type: "GET",
            data: {
            ...
            success: function (data) {
                ...
                $("#specialsheader").dxDataGrid({
                    ...
                    onRowClick:function(e){
                        ...
                        $.ajax({
                            url: '<?php echo url("/getSpecialsLines"); ?>',
                            type: "GET",
                            data: {
                                ID : headerID,
                            },
                            success: function (data) {
                                ...
                                const orderlines = $("#specialslines").dxDataGrid({
                                    ...
                                    onExporting(e) {
                                        ...
                                        $.ajax({
                                            url: '<?php echo url("/exportToExcel"); ?>',
                                            type: "GET",
                                            data: {
                                                ID : headerID,
                                            },
...
<?php /**PATH C:\Users\deadl\Downloads\smdfmerchieadmin (3)\smdfmerchieadmin\dims21\resources\views/merchie/specials.blade.php ENDPATH**/ ?>