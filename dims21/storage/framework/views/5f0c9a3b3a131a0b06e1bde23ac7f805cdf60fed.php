...
<html>
    <head>
    <script src="<?php echo e(asset('js/ag_grid.js')); ?>"></script>
    <script src="<?php echo e(asset('public/js/jquery-2.2.3.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery-ui.js')); ?>"></script>
    <link rel="stylesheet" href="<?php echo e(asset('css/ag_css.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/ag_cc_theme.css')); ?>">
...
$('#fetchData').click(function () {
                    $.ajax({
                        url: '<?php echo url("/getMerchieOrders"); ?>',
                        type: "GET",
                        data: {
            ...
            onRowClick: function (e) {
                ...
                $.ajax({
                        url: '<?php echo url("/getMerchieOrderLines"); ?>',
                        type: "GET",
                        data: {
...
</html><?php /**PATH C:\Users\deadl\Downloads\smdfmerchieadmin (3)\smdfmerchieadmin\dims21\resources\views/merchie/orders.blade.php ENDPATH**/ ?>