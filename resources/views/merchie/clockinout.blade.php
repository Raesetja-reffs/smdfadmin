...
<html>
    ...
    <body style="font-family: Sans-serif">
        <div class="col-12 p-3">
            ...
            <div class="row align-items-center mt-1">
                ...
                <div class="col-1">
                    <button type="button" id="getReport" class="btn btn-primary btn-sm w-100" onclick="window.location.href='{!!url("/userLoggingReport")!!}'">Clocking Report</button>
	...
	<script>
		var jArray = JSON.stringify({!!json_encode($clockinout) !!});
		var jArrayMerchieCodes = JSON.stringify({!!json_encode($merchiecodes) !!});
		...
		$(document).ready(function() {
			...
			$('#submitParams').click(function() {
				...
				//console.log(Time);
				$.ajax({
					url: '{!!url("/insertClockInOutRecord")!!}',
					type: "POST",
					data: {
						User: User,
						Type: Type,
			...
			$("#gridContainer").dxDataGrid({
				...
				onRowRemoving: function(e) {
					...
					//console.debug(ID);
					$.ajax({
						url: '{!!url("/deleteClockInOutRecord")!!}',
						type: "POST",
						data: {
							ID: ID,
						},
