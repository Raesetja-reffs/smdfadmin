...
<script>
    ...
    var jArray = JSON.stringify({!! json_encode($merchies) !!});
    var jArrayCustomerCode =JSON.stringify({!! json_encode($customercode) !!});
